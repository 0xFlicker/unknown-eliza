...
export default function OnboardingTour() {
  ...
  const homeSteps = [
    ...
    {
      target:
        ".sidebar-docs-button, .sidebar-logs-button, .sidebar-settings-button",
      content:
        "Access documentation, system logs, and global settings from these utility buttons.",
      title: "System Utilities",
    },
    {
      target: ".sidebar-connection-status",
      content:
        "This indicator shows your connection status to the ElizaOS server.",
    ...
    },
    {
      ...
      content:
        "View agent details or configure settings using these buttons on each agent card.",
    ...
    },
    {
      ...
      content:
        "Let's create your first agent! Click this button to get started.",
  ...
  const createAgentSteps = [
    {
      ...
      content:
        "Give your agent a name that reflects its purpose or personality.",
