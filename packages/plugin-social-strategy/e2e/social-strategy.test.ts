import { type PlayerEntity } from "../src/socialStrategy/types.ts";
import { ChannelType, IAgentRuntime } from "@elizaos/core";
import {
  ConversationScript,
  ConversationSimulator,
} from "./ConversationSimulator.ts";
...
export const socialStrategyTestSuite: TestSuite = {
  name: "social-strategy",
  description: "E2E tests for the social-strategy plugin",
...
export default socialStrategyTestSuite;
