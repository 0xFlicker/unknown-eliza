...
mock.module("@elizaos/plugin-sql", () => ({
  ...
  DatabaseMigrationService: jest.fn(() => ({
    initializeWithDatabase: jest
      .fn()
      .mockReturnValue(Promise.resolve(undefined)),
    discoverAndRegisterPluginSchemas: jest.fn(),
    runAllPluginMigrations: jest
      .fn()
      .mockReturnValue(Promise.resolve(undefined)),
  })),
  plugin: {},
  ...
  describe("Agent Management", () => {
    ...
    beforeEach(async () => {
      ...
      server.database = {
        ...
        createMessageServer: jest
          .fn()
          .mockReturnValue(Promise.resolve({ id: "server-id" })),
        db: {
          execute: jest.fn().mockReturnValue(Promise.resolve([])),
        },
        addAgentToServer: jest.fn().mockReturnValue(Promise.resolve(undefined)),
  ...
  describe("Database Operations", () => {
    beforeEach(async () => {
      ...
      server.database = {
        ...
        createChannel: jest
          .fn()
          .mockReturnValue(Promise.resolve({ id: "channel-id" })),
        getChannelsForServer: jest.fn().mockReturnValue(Promise.resolve([])),
        createMessage: jest
          .fn()
          .mockReturnValue(Promise.resolve({ id: "message-id" })),
