...
export interface ChannelCapacityExceededPayload {
  channelId: UUID;
  reason: 'participant_limit' | 'total_limit';
  droppedMessage?: MessageServiceStructure;
}
...
export interface MessageBusEventMap {
  ...
  channel_capacity_exceeded: ChannelCapacityExceededPayload;
  game_action: unknown;
  game_event: unknown;
