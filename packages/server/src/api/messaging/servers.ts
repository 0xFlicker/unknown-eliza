  ...
  (router as any).post(
    ...
    async (req: express.Request, res: express.Response) => {
      ...
      try {
        ...
        res
          .status(500)
          .json({ success: false, error: "Failed to add agent to server" });
      }
    },
  );
  ...
  (router as any).get(
    ...
    async (req: express.Request, res: express.Response) => {
      ...
      try {
        ...
        res
          .status(500)
          .json({ success: false, error: "Failed to fetch server agents" });
      }
    },
  );
  ...
  (router as any).get(
    ...
    async (req: express.Request, res: express.Response) => {
      ...
      try {
        ...
        res
          .status(500)
          .json({ success: false, error: "Failed to fetch agent servers" });
      }
    },
  );
