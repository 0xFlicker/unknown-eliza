...
export const openaiPlugin: Plugin = {
  ...
  models: {
    ...
    [ModelType.TEXT_SMALL]: async (
      ...
      logger.debug(`[OpenAI] Using TEXT_SMALL model: ${modelName}`);
      // logger.trace(prompt);
    ...
    [ModelType.TEXT_LARGE]: async (
      ...
      logger.debug(`[OpenAI] Using TEXT_LARGE model: ${modelName}`);
      // logger.trace(prompt);
  ...
  tests: [
    {
      ...
      tests: [
        ...
        },
        {
          ...
          fn: async (runtime: IAgentRuntime) => {
            logger.info("openai_test_image_generation");
            try {
              ...
              logger.info("generated with test_image_generation:", image);
            } catch (error: unknown) {
              const message =
                error instanceof Error ? error.message : String(error);
        ...
        },
        {
          ...
          fn: async (runtime: IAgentRuntime) => {
            try {
              logger.info("openai_test_image_description");
              try {
