...
describe('Rolodex Actions', () => {
  ...
  beforeEach(() => {
    ...
    mockRuntime = createMockRuntime({
      ...
      useModel: vi
        .fn()
        .mockResolvedValue('<response><contactName>John Doe</contactName></response>'),
    });
  ...
  describe('searchContactsAction', () => {
    ...
    it('should search and display contacts', async () => {
      ...
      mockRuntime.getEntityById = vi
        .fn()
        .mockResolvedValueOnce({ id: stringToUuid('john'), names: ['John Doe'], metadata: {} })
        .mockResolvedValueOnce({ id: stringToUuid('sarah'), names: ['Sarah Smith'], metadata: {} });
